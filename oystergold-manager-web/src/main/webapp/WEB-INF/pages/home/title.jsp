...
//			alert((0-currLeft) <= maxOffset);
		...
		function logout(){
			...
			self.top.location.href="${ctx}/loginAction_loginout";
			return false;
		}
...
<div id="menuContent">
	...
	<span id="topmenu" onclick="toModule('vipuser');">会员中心</span><span id="tm_separator"></span>
	<span id="topmenu" onclick="toModule('settlecenter');">结算中心</span><span id="tm_separator"></span>
	<span id="topmenu" onclick="toModule('item');">商品管理</span><span id="tm_separator"></span>
