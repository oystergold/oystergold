		...
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent">
    				...
    				url:'${ctx}/sysadmin/deptAction_ajaxAllDept?deptId=${deptId}'" 
    				value="${deptP.deptId }" /> 
	            </td>
	        </tr>		
	        <tr>
	            <td class="columnTitle">部门名称：</td>
	            <td class="tableContent"><input type="text" name="deptName" style="width:300px" value="${deptName}"/>
	            </td>
	        </tr>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><select id="deptStateID" class="easyui-combobox" name="state" style="width:200px;" data-options="height:auto">   
    										<option value="1" ${state ==1 ?"selected":""}>正常</option>   
   											<option value="0"  ${state ==0 ?"selected":""}>暂停</option> </td>
	        </tr>			
		</table>
	</div>
