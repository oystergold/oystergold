		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
	            	<input id="modulecombobox_comboboxID" class="easyui-combobox" name="parentId"   
    				style="width:300px"
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="isLeaf" value="1" checked class="input"/>是
	            	<input type="radio" name="isLeaf" value="0" class="input"/>否
	            </td>
	        </tr>		
	        <tr>
