...
<ul>
<c:if test="${state == 1}">
<li id="save"><a href="#" onclick="formSubmit('exportAction_checkContractOK','_self');this.blur();">审核</a></li>
</c:if>
<li id="back"><a href="#" onclick="history.go(-1);">返回</a></li>
<c:if test="${state == 1}">
<li id="save"><a href="#" onclick="formSubmit('exportAction_returnContract','_self');this.blur();">退回</a></li>
</c:if>
</ul>
  </div>
</div>
