...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('contractProductAction_addContractProduct','_self');this.blur();">保存</a></li>
<li id="back"><a href="#" onclick="history.go(-1);">返d回</a></li>
</ul>
  </div>
</div>
</div>
		...
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent">
	            	 <s:select theme="simple" name="factory.id" list="factoryList" 
